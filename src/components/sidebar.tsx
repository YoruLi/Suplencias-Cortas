...
export default function Sidebar({ session }: { session: Session | undefined }) {
    ...
    return (
        <aside className="lg:min-w-[230px] lg:max-w-[230px] z-[51] bg-white border-t-2 lg:border-r-2 [overflow-y:overlay] overflow-hidden scrollbar-main  fixed bottom-0 w-full lg:relative lg:top-0 lg:h-[100dvh] flex flex-col">
            <nav className="flex flex-row lg:flex-col w-full justify-between [&>div>ul>a>span]:text-sm">
                <h1 className="text-main font-bold order-1 lg:order-none px-6 font-stalinist text-center lg:text-2xl text-lg lg:py-4 my-auto py-0 block">SSDSP</h1>
