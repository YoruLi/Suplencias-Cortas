...
export default function Sidebar() {
    ...
    return (
        <aside className="lg:w-[230px] z-[51] bg-transparent border-t-2 lg:border-r-2 [overflow-y:overlay] overflow-hidden scrollbar-main fixed bottom-0 w-full lg:sticky lg:top-0 lg:h-[100dvh] flex flex-col">
