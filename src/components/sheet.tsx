...
import CourseItem from "./cursos/course-item";
import { SelectNameCourse } from "./cursos/select-name-course";
import { editCourseWithId } from "./cursos/api/edit-course-with-id";
