...
const DinamycFormUserDetail = lazy(() => import("@/app/(pages)/docentes/components/form/form-user-detail"));
const DinamycFormUserPersonalDetail = lazy(() => import("@/app/(pages)/docentes/components/form/form-user-personal-detail"));
const DinamycFormUserMoreDetail = lazy(() => import("@/app/(pages)/docentes/components/form/form-user-more-detail"));
const DinamycConfirm = lazy(() => import("@/app/(pages)/docentes/components/form/confirm"));
                ...
                <div className=" mx-auto  bg-transparent relative">
                    <ul className="relative flex gap-4 mt-4 ">
                        {STEPS.map((step, index) => {
                            return (
                                <li key={index} className="flex gap-1 place-items-center text-center relative bg-transparent z-40 ">
                                    <span
